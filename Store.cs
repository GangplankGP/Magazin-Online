...
namespace Proiect_POO
{
    public class Store
    {
        ...
        public void SaveData()
        {
            foreach(var p in Produse)
            {
                File.WriteAllText("C:/Users/tudor/OneDrive/Desktop/AN2_ACIS/POO/Proiect_POO/Proiect_POO/store.json", JsonConvert.SerializeObject(p));
            }
        }
        ...
        {
            if (File.Exists("C:/Users/tudor/OneDrive/Desktop/AN2_ACIS/POO/Proiect_POO/Proiect_POO/store.json"))
            {
                //Produse= new List<Produs>();

                Produse.Add(JsonConvert.DeserializeObject<Produs>(File.ReadAllText("C:/Users/tudor/OneDrive/Desktop/AN2_ACIS/POO/Proiect_POO/Proiect_POO/store.json")));
            }
            else
                Produse = new List<Produs>();
        }
